    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop_id', models.PositiveIntegerField(verbose_name='ID магазина', default=456)),
                ('scid', models.PositiveIntegerField(verbose_name='Номер витрины', default=123)),
                ...
                ('success_url', models.URLField(verbose_name='URL успешной оплаты', default='http://example.com/success-payment/')),
                ('fail_url', models.URLField(verbose_name='URL неуспешной оплаты', default='http://example.com/fail-payment/')),
