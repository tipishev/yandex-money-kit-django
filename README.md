...
Модуль оплаты yandexmoney-kit-django необходим для интеграции с сервисом [Яндекс.Касса](http://kassa.yandex.ru/) на базе фрэймворка [Django](https://www.djangoproject.com).
...
* Установить пакет:
```
        pip install git+https://github.com/tipishev/yandex-money-kit-django.git
```
...
```
* Указать в личном кабинете Яндекс.Деньги настройки для приёма уведомлений:
...
###Использование
[Полный пример использования](<https://github.com/tipishev/django-yandex-money/tree/develop/example>)
...
Любое использование вами программы означает полное и безоговорочное принятие вами условий лицензионного договора, размещённого по адресу https://money.yandex.ru/doc.xml?id=527132 (далее – «Лицензионный договор»). 
